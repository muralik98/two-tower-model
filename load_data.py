...
def load_data() -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    article_df = pd.read_csv(r"C:\Users\mural\CODING_MK\PROJECT\Portfolio_Project\TwoTowerModel\ref\hm-two-step-reco-main\articles.csv.zip")
    for categ_variable in Variables.ARTICLE_CATEG_VARIABLES:
        article_df[categ_variable] = article_df[categ_variable].astype(str)

    customer_df = pd.read_csv(r"C:\Users\mural\CODING_MK\PROJECT\Portfolio_Project\TwoTowerModel\ref\hm-two-step-reco-main\customers.csv.zip")
    ...
    transactions_df = pd.read_csv(r"C:\Users\mural\CODING_MK\PROJECT\Portfolio_Project\TwoTowerModel\ref\hm-two-step-reco-main\transactions_train.csv.zip")
